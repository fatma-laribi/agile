...
class OffersPage extends StatefulWidget {
  String username;
  OffersPage({Key? key,required this.username}) : super(key: key);
  @override
  State<OffersPage> createState() => _MyOffersPage();
}

class _MyOffersPage extends State<OffersPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.username+"'s Offers page",style: TextStyle(color: Colors.black),),
        elevation: 0.0,
        backgroundColor: Colors.transparent,
      ),
      body:
      FutureBuilder(
        future: getOffersByUsername(widget.username),
